...
|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|
| `EditorOnlyField`  | Field is only editable in Edit mode.                                                                                                                                                                                                                                                                                                                                                                                         | Decorator      |
| `PlayOnlyField`    | Field is only editable in Play mode.                                                                                                                                                                                                                                                                                                                                                                                         | Decorator      |
| `ReadOnlyField`    | Field is not editable.                                                                                                                                                                                                                                                                                                                                                                                                       | Decorator      |
| `Button`           | Displays a button. Can be displayed at the bottom, or above/below the field.                                                                                                                                                                                                                                                                                                                                                 | Decorator      |
...
| `Inline`           | Removes the foldout from a group of serialized fields. When applied to Objects, shows an inline Editor.                                                                                                                                                                                                                                                                                                                      | Decorator      |
| `CustomHeader`     | A `HeaderAttribute` that allows margin and font size to be overridden.                                                                                                                                                                                                                                                                                                                                                       | Decorator      |

> **Note**  
> These implementations perform no logic to implement nested property drawers.

## Installation
[![openupm](https://img.shields.io/npm/v/com.vertx.attributes?label=openupm&registry_uri=https://package.openupm.com)](https://openupm.com/packages/com.vertx.attributes/)
